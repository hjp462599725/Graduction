...
$(function() {
	...
	$(".numberspinner").change(function(){
		...
		if(value>max)
			...
			this.value = min;
		$("#maingr_second").closest("div.line").children().children(".numberspinner")
	...
	secondList.change(function() {
		...
		if (sencond_appoint) {
			var vals = [];
			secondList.children("input").each(function() {
				if (this.checked) {
	...
	minList.change(function() {
		...
		if (min_appoint) {
			var vals = [];
			minList.children("input").each(function() {
				if (this.checked) {
					vals.push(this.value);
				}
			});
	...
	hourList.change(function() {
		...
		if (hour_appoint) {
			var vals = [];
			hourList.children("input").each(function() {
				if (this.checked) {
					vals.push(this.value);
				}
			});
	...
	dayList.change(function() {
		...
		if (day_appoint) {
			var vals = [];
			dayList.children("input").each(function() {
				if (this.checked) {
					vals.push(this.value);
				}
			});
	...
	mouthList.change(function() {
		...
		if (mouth_appoint) {
			var vals = [];
			mouthList.children("input").each(function() {
				if (this.checked) {
					vals.push(this.value);
				}
			});
	...
	weekList.change(function() {
		...
		if (week_appoint) {
			var vals = [];
			weekList.children("input").each(function() {
				if (this.checked) {
					vals.push(this.value);
				}
			});
